...
public partial class NovaPostagem : Window
{
    ...
    private void TxtConteudo_OnTextChanged(object sender, TextChangedEventArgs e)
    {
    ...
    private void BtnPostar_OnClick(object sender, RoutedEventArgs e)
    {
        ...
        {
            MessageBox.Show("Escreva algo no conteúdo!");
            TbConteudo.Focus();
            return;
        }
        ...
        try
        {
            conexao.Open();
             ...
             if (linhasAfetadas < 1) throw new Exception("Erro ao postar conteúdo!");
