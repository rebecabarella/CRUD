...
public partial class Feed : Window
{
    ...
    private void BtnApagarPost_OnClick(object sender, RoutedEventArgs e)
    {
        var resultadoConfirmacao = MessageBox.Show("Tem certeza que deseja apagar postagem?",
        ...
        try
        {
         conexao.Open();
         var linhasAfetadas = comando.ExecuteNonQuery();
         if (linhasAfetadas < 1) throw new Exception($"Erro ao deletar post!");
         MessageBox.Show("Postagem apagada com sucesso!");
         CarregarPosts_QuandoIniciar();
        }
    ...
    private void BtnEditarPost_OnClick(object sender, RoutedEventArgs e)
    {
